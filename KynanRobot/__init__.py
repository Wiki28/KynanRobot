...
if ENV:
    ...
    DB_URI = os.environ.get("DATABASE_URL", "postgres://crixhgus:ZAGBKVvFMHydslI_ZoAzdJm48kRsyogv@mahmud.db.elephantsql.com/crixhgus")
    ARQ_API = os.environ.get("ARQ_API", None)
    ARQ_API_URL = os.environ.get("ARQ_API_URL", "https://thearq.tech/")
    ARQ_API_KEY = os.environ.get("ARQ_API_KEY", "UFNQIB-JXAQQT-XHFAWT-NDWYGN-ARQ")
    ...
    SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "xgcwiki")
